        ...
        <div class="col-md-6 position-relative pb-3 pb-md-0 mb-2 mb-sm-3 mb-md-0">
            ...
            <div class="binded-content zindex-2">
                ...
                <div class="binded-item active" id="image1"><img class="d-block rounded-5"
                        src="{{ invitation_asset('landing_page') }}/img/landing/marketing-agency/case-studies/01.jpg"
                        alt="Image"></div>
                <!-- Item-->
                <div class="binded-item" id="image2"><img class="d-block rounded-5"
                        src="{{ invitation_asset('landing_page') }}/img/landing/marketing-agency/case-studies/02.jpg"
                        alt="Image"></div>
                <!-- Item-->
                <div class="binded-item" id="image3"><img class="d-block rounded-5"
                        src="{{ invitation_asset('landing_page') }}/img/landing/marketing-agency/case-studies/03.jpg"
                        alt="Image"></div>
            </div>
        </div>
        <div class="col-md-6 col-xl-5 offset-xl-1">
            <div class="ps-md-4 ps-xl-0">
                <div class="d-flex align-items-center ms-n3 pb-3 mb-sm-2 mb-xl-4">
                    ...
                    <div class="text-center text-nowrap mx-3" id="slides-count" style="width: 33px;">
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide pb-1" data-swiper-binded="#image1">
                            ...
                            <div class="d-sm-flex"><a
                                    ...
                                    href="landing-marketing-agency.html#">Read a full story</a><a
                                    class="btn btn-outline-primary w-100 w-sm-auto d-md-none d-lg-inline-flex"
                                    href="landing-marketing-agency.html#">All case studies</a></div>
                        </div>
                        <!-- Item-->
                        ...
                        <div class="swiper-slide pb-1" data-swiper-binded="#image3">
                            <h3 class="h4">Growth of subscribers and sales on social networks for the eco
                                cosmetics</h3>
                            <p class="pb-3 mb-3 mb-xl-4">Sapien ultrices egestas at faucibus eu diam velit
                                diam id amet nibh quam rutrum diam fermentum diam natoque scelerisque viverra
