                ...
                <div class="col-md-4 col-lg-3 offset-lg-1 mb-3 mb-md-0">
                    ...
                    <div class="binded-content">
                        ...
                        <div class="binded-item active" id="author1"><img class="d-block rounded-circle mb-3"
                                src="{{ invitation_asset('landing_page') }}/img/avatar/13.jpg" width="86"
                        ...
                        <div class="binded-item" id="author2"><img class="d-block rounded-circle mb-3"
                                src="{{ invitation_asset('landing_page') }}/img/avatar/14.jpg" width="86"
                                alt="Darell Steward">
                        ...
                        <div class="binded-item" id="author3"><img class="d-block rounded-circle mb-3"
                                src="{{ invitation_asset('landing_page') }}/img/avatar/15.jpg" width="86"
                                alt="Annette Black">
                        ...
                        <div class="binded-item" id="author4"><img class="d-block rounded-circle mb-3"
                                src="{{ invitation_asset('landing_page') }}/img/avatar/16.jpg" width="86"
                                alt="Ralph Edwards">
                  ...
                  &quot;clickable&quot;: true
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide" data-swiper-binded="#author4">
                                <p class="text-dark lead mb-0">“Vestibulum faucibus lectus eget augue
                                    pharetra, quis semper lectus gravida. Vestibulum pretium in elit sed
                                    iaculis. Curabitur elementum turpis at ipsum molestie, id maximus odio
                                    tincidunt. Praesent id lacinia orci. Phasellus at varius arcu. Ut nec
                                    lobortis velit. Mauris vel risus quis lacus placerat fringilla.”</p>
                            </div>
                        </div>
                    </div>
                </div>
