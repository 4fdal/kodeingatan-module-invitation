            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide w-auto">
                    <div class="card-hover text-center" style="max-width: 306px;"><img class="d-block rounded-5 mb-4"
                            src="{{ invitation_asset('landing_page') }}/img/landing/creative-agency/team/02.jpg"
                            alt="Image">
                        ...
                        <div class="d-none d-lg-flex nav justify-content-center opacity-0"><a
                                class="nav-link btn btn-icon btn-sm fs-sm fw-normal me-1"
                                href="landing-marketing-agency.html#"><i class="ai-instagram"></i></a><a
                                class="nav-link btn btn-icon btn-sm fs-sm fw-normal me-1"
                                href="landing-marketing-agency.html#"><i class="ai-facebook"></i></a><a
                                class="nav-link btn btn-icon btn-sm fs-sm fw-normal"
                                href="landing-marketing-agency.html#"><i class="ai-linkedin"></i></a></div>
                ...
                <div class="swiper-slide w-auto">
                    <div class="card-hover text-center" style="max-width: 306px;"><img class="d-block rounded-5 mb-4"
                            src="{{ invitation_asset('landing_page') }}/img/landing/creative-agency/team/01.jpg"
                            alt="Image">
                        <h3 class="h5 mb-1">Guy Hawkins</h3>
                        <p class="text-muted mb-2">President of Sales</p>
                        <div class="d-none d-lg-flex nav justify-content-center opacity-0"><a
                                class="nav-link btn btn-icon btn-sm fs-sm fw-normal me-1"
                                href="landing-marketing-agency.html#"><i class="ai-twitter"></i></a><a
                                class="nav-link btn btn-icon btn-sm fs-sm fw-normal me-1"
                                href="landing-marketing-agency.html#"><i class="ai-facebook"></i></a><a
                                class="nav-link btn btn-icon btn-sm fs-sm fw-normal"
                                href="landing-marketing-agency.html#"><i class="ai-instagram"></i></a></div>
                        <div class="d-lg-none nav justify-content-center"><a
                                class="nav-link btn btn-icon btn-sm fs-sm fw-normal me-1"
                                href="landing-marketing-agency.html#"><i class="ai-twitter"></i></a><a
                                class="nav-link btn btn-icon btn-sm fs-sm fw-normal me-1"
                ...
                <div class="swiper-slide w-auto">
                    <div class="card-hover text-center" style="max-width: 306px;"><img class="d-block rounded-5 mb-4"
                            src="{{ invitation_asset('landing_page') }}/img/landing/creative-agency/team/06.jpg"
                            alt="Image">
                        ...
                        <div class="d-none d-lg-flex nav justify-content-center opacity-0"><a
                                ...
                                href="landing-marketing-agency.html#"><i class="ai-facebook"></i></a><a
                                class="nav-link btn btn-icon btn-sm fs-sm fw-normal me-1"
                                href="landing-marketing-agency.html#"><i class="ai-behance"></i></a><a
                                class="nav-link btn btn-icon btn-sm fs-sm fw-normal"
                                href="landing-marketing-agency.html#"><i class="ai-dribbble"></i></a></div>
                        <div class="d-lg-none nav justify-content-center"><a
                                class="nav-link btn btn-icon btn-sm fs-sm fw-normal me-1"
                                href="landing-marketing-agency.html#"><i class="ai-facebook"></i></a><a
                                class="nav-link btn btn-icon btn-sm fs-sm fw-normal me-1"
                ...
                <div class="swiper-slide w-auto">
                    <div class="card-hover text-center" style="max-width: 306px;"><img class="d-block rounded-5 mb-4"
                            src="{{ invitation_asset('landing_page') }}/img/landing/creative-agency/team/04.jpg"
                            alt="Image">
                ...
                <div class="swiper-slide w-auto">
                    <div class="card-hover text-center" style="max-width: 306px;"><img class="d-block rounded-5 mb-4"
                            src="{{ invitation_asset('landing_page') }}/img/landing/creative-agency/team/03.jpg"
                            alt="Image">
                ...
                <div class="swiper-slide w-auto">
                    <div class="card-hover text-center" style="max-width: 306px;"><img class="d-block rounded-5 mb-4"
                            src="{{ invitation_asset('landing_page') }}/img/landing/creative-agency/team/05.jpg"
                            alt="Image">
