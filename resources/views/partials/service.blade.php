<section class="container py-5 my-md-2 my-lg-3 my-xl-4 my-xxl-5">
    <div class="row align-items-center py-1 py-sm-3 py-md-4 my-lg-2">
        <div class="col-lg-4 offset-xl-1">
            ...
            </ul><a class="btn btn-primary d-none d-lg-inline-flex" href="landing-marketing-agency.html#">See
                all servises</a>
        </div>
        <div class="col-lg-8 col-xl-7 col-xxl-6">
            ...
            <div class="d-lg-none text-center pt-3 mt-3 mt-sm-4"><a class="btn btn-primary"
                    href="landing-marketing-agency.html#">See all servises</a></div>
        </div>
    </div>
</section>
