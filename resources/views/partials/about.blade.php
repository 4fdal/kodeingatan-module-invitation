<section class="overflow-hidden pb-5 mb-lg-3 mb-xl-4 mb-xxl-5">
    <div class="container pb-sm-2 pb-md-3 pb-lg-5 mb-md-3 mb-lg-0">
        ...
        <div class="position-relative mx-auto" style="max-width: 1198px;">
            <div class="position-relative zindex-3" data-aos="fade-left" data-aos-duration="600" data-aos-offset="300"><img
                    src="{{ invitation_asset('landing_page') }}/img/landing/marketing-agency/about/01.png" alt="Image">
            </div>
            <div class="position-absolute top-0 start-0 zindex-2" data-aos="fade-right" data-aos-duration="600"
                data-aos-offset="300"><img
                    src="{{ invitation_asset('landing_page') }}/img/landing/marketing-agency/about/02.png"
                    alt="Image"></div>
            ...
            <div class="col-md-6 col-xxl-5 offset-xxl-1 mb-4 mb-md-0">
                <div class="text-center text-md-start pe-md-4 pe-xl-5 pe-xxl-0">
                    ...
                    <p class="fs-lg mb-2 mb-sm-3 mb-xl-4 mx-auto mx-md-0" style="max-width: 475px;">Sapien
                        ...
                        class="btn btn-lg btn-link px-0" href="landing-marketing-agency.html#">More about us<i
                        ...
                        <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px;">
                            <div
                                ...
                                <img class="d-block d-dark-mode-none"
                                    src="{{ invitation_asset('landing_page') }}/img/landing/saas-1/brands/klinos-gray.svg"
                                    width="120" alt="Klinos"><img class="d-none d-dark-mode-block"
                                    src="{{ invitation_asset('landing_page') }}/img/landing/saas-1/brands/klinos-light.svg"
                    ...
                    <div class="col">
                        <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px;">
                            <div
                                class="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                                <img class="d-block d-dark-mode-none"
                                    src="{{ invitation_asset('landing_page') }}/img/landing/saas-1/brands/starcraft-gray.svg"
                                    width="147" alt="Starcraft"><img class="d-none d-dark-mode-block"
                                    src="{{ invitation_asset('landing_page') }}/img/landing/saas-1/brands/starcraft-light.svg"
                    ...
                    <div class="col">
                        <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px;">
                            <div
                                class="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                                <img class="d-block d-dark-mode-none"
                                    src="{{ invitation_asset('landing_page') }}/img/landing/saas-1/brands/airbnb-gray.svg"
                                    width="121" alt="Airbnb"><img class="d-none d-dark-mode-block"
                                    src="{{ invitation_asset('landing_page') }}/img/landing/saas-1/brands/airbnb-light.svg"
                    ...
                    <div class="col">
                        <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px;">
                            <div
                                class="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                                <img class="d-block d-dark-mode-none"
                                    src="{{ invitation_asset('landing_page') }}/img/landing/saas-1/brands/alpine-gray.svg"
                                    width="132" alt="Alpine"><img class="d-none d-dark-mode-block"
                                    src="{{ invitation_asset('landing_page') }}/img/landing/saas-1/brands/alpine-light.svg"
                    ...
                    <div class="col">
                        <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px;">
                            <div
                                class="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                                <img class="d-block d-dark-mode-none"
                                    src="{{ invitation_asset('landing_page') }}/img/landing/saas-1/brands/foster-gray.svg"
                                    width="132" alt="Foster"><img class="d-none d-dark-mode-block"
                                    src="{{ invitation_asset('landing_page') }}/img/landing/saas-1/brands/foster-light.svg"
                    ...
                    <div class="col">
                        <div class="ratio ratio-21x9 position-relative mx-auto" style="max-width: 180px;">
                            <div
                                class="d-flex align-items-center justify-content-center position-absolute top-0 start-0 w-100 h-100 px-3">
                                <img class="d-block d-dark-mode-none"
                                    src="{{ invitation_asset('landing_page') }}/img/landing/saas-1/brands/champion-gray.svg"
                                    width="130" alt="Champion"><img class="d-none d-dark-mode-block"
                                    src="{{ invitation_asset('landing_page') }}/img/landing/saas-1/brands/champion-light.svg"
