        ...
        <div class="row align-items-center pt-5 mt-4 mt-xxl-0">
                        ...
                        <div class="position-relative mx-auto"
                            ...
                            <div class="position-absolute start-50 translate-middle-x" style="top: 4.4%; width: 85%;">
                                ...
                                <div class="d-flex align-items-center"><img class="rounded-circle"
                                        src="{{ invitation_asset('landing_page') }}/img/landing/marketing-agency/hero/avatar.jpg"
                                        width="35" alt="Avatar">
                            ...
                            <video class="d-block w-100" autoplay loop muted
                                ...
                                <source
                                    src="{{ invitation_asset('landing_page') }}/img/landing/marketing-agency/hero/video.mp4"
                                    type="video/mp4">
                            </video>
                        </div>
                    </div>
                    <div class="parallax-layer" data-depth="0.3"><img
                            src="{{ invitation_asset('landing_page') }}/img/landing/marketing-agency/hero/shape01.svg"
                            alt="Background shape">
                    </div>
                    <div class="parallax-layer zindex-2" data-depth="-0.1"><img
                            src="{{ invitation_asset('landing_page') }}/img/landing/marketing-agency/hero/shape02.svg"
                            alt="Background shape">
                    </div>
                    <div class="parallax-layer" data-depth="-0.15"><img
                            src="{{ invitation_asset('landing_page') }}/img/landing/marketing-agency/hero/shape03.svg"
                            alt="Background shape">
                    </div>
                    <div class="parallax-layer zindex-2" data-depth="-0.25"><img
                            src="{{ invitation_asset('landing_page') }}/img/landing/marketing-agency/hero/shape04.svg"
                            alt="Background shape">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 text-center text-lg-start">
                ...
                <div class="d-sm-flex justify-content-center justify-content-lg-start pt-5 mt-lg-2"><a
                        ...
                        href="landing-marketing-agency.html#">Get in touch</a><a class="btn btn-lg btn-link"
                        href="landing-marketing-agency.html#">Our case studies<i class="ai-arrow-right ms-2"></i></a>
                </div>
            </div>
        </div>
    </div>
