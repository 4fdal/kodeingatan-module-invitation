     ...
     <div class="container py-sm-2 pt-md-3 py-lg-2 py-xl-4 py-xxl-5">
      ...
      ">
                 ...
                 <article class="swiper-slide h-auto">
                     <div class="card border-0 h-100">
                         <div class="card-body pb-4">
                             <div class="d-flex align-items-center mb-4 mt-n1"><span class="fs-sm text-muted">August 13,
                                     2022</span><span class="fs-xs opacity-20 mx-3">|</span><a
                                     class="badge text-nav fs-xs border"
                                     href="landing-marketing-agency.html#">Inspiration</a></div>
                             <h3 class="h4 card-title"><a href="landing-marketing-agency.html#">Promotion of
                                     an online store from scratch, first sales</a></h3>
                         ...
                         <div class="card-footer pt-3"><a class="d-flex align-items-center text-decoration-none pb-2"
                                 href="landing-marketing-agency.html#"><img class="rounded-circle"
                                     src="{{ invitation_asset('landing_page') }}/img/avatar/10.jpg" width="48"
                                     alt="Post author">
                     ...
                     <div class="card border-0 h-100">
                         <div class="card-body pb-4">
                             <div class="d-flex align-items-center mb-4 mt-n1"><span class="fs-sm text-muted">July 25,
                                     ...
                                     class="badge text-nav fs-xs border"
                                     href="landing-marketing-agency.html#">Inspiration</a></div>
                             <h3 class="h4 card-title"><a href="landing-marketing-agency.html#">Business
                                     strategy for a brand of vintage bags</a></h3>
                         ...
                         <div class="card-footer pt-3"><a class="d-flex align-items-center text-decoration-none pb-2"
                                 href="landing-marketing-agency.html#"><img class="rounded-circle"
                                     src="{{ invitation_asset('landing_page') }}/img/avatar/07.jpg" width="48"
                                     alt="Post author">
                     ...
                     <div class="card border-0 h-100">
                         <div class="card-body pb-4">
                             <div class="d-flex align-items-center mb-4 mt-n1"><span class="fs-sm text-muted">July 08,
                                     ...
                                     class="badge text-nav fs-xs border"
                                     href="landing-marketing-agency.html#">Inspiration</a></div>
                             <h3 class="h4 card-title"><a href="landing-marketing-agency.html#">Sales on
                                     social networks for the eco cosmetics</a></h3>
                         ...
                         <div class="card-footer pt-3"><a class="d-flex align-items-center text-decoration-none pb-2"
                                 href="landing-marketing-agency.html#"><img class="rounded-circle"
                                     src="{{ invitation_asset('landing_page') }}/img/avatar/09.jpg" width="48"
                                     alt="Post author">
         ...
         <div class="text-center pt-4 pb-1 pb-sm-2 pb-md-4 py-lg-5 my-2 mt-lg-0"><a class="btn btn-outline-primary"
                 href="landing-marketing-agency.html#">Read all articles</a>
         </div>
     </div>
