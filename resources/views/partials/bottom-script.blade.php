...
<script src="{{ invitation_asset('landing_page') }}/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
<script src="{{ invitation_asset('landing_page') }}/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js"></script>

<script src="{{ invitation_asset('landing_page') }}/vendor/cleave.js/dist/cleave.min.js"></script>
<script src="{{ invitation_asset('landing_page') }}/vendor/parallax-js/dist/parallax.min.js"></script>
<script src="{{ invitation_asset('landing_page') }}/vendor/swiper/swiper-bundle.min.js"></script>
<script src="{{ invitation_asset('landing_page') }}/vendor/aos/dist/aos.js"></script>
<!-- Main theme script-->
<script src="{{ invitation_asset('landing_page') }}/js/theme.min.js"></script>
<!-- Customizer-->
<script>
    ! function() {
        function e(e) {
