        ...
        <div class="row pb-5 pt-sm-2 mb-lg-2">
            ...
            <div class="col-sm-3 col-lg-2 offset-xl-1 mb-4 mb-sm-0">
                <ul class="nav flex-column">
                    ...
                    <li><a class="nav-link py-1 px-0" href="landing-marketing-agency.html#">Case studies</a>
                    </li>
                    <li><a class="nav-link py-1 px-0" href="landing-marketing-agency.html#">Privacy policy</a>
                    </li>
                </ul>
            </div>
